...
export const Level = ({ levelStyle, number, levelTitle, levelDescription, medal = '', completedMissions = '0', totalMissions = 1, enable = true, subsequent = false, date, setActiveMessage, navigation }: Props) => {
            ...
            <Text style={[ stylesLevel.textLevelDescription, !enable ? stylesLevel.textLevelLocked : null ]}>{ levelDescription }</Text>
            {
                ...
                ? (
                    ...
                    <View style={ stylesLevel.lockedMissionsWrapper }>
                        ...
                        />
                        <Text style={ stylesLevel.lockedMissionsText }>{ date }</Text>
                    </View>
                )
            }
        </TouchableOpacity>
