...
export const InstructionsLevel5Mission2 = ({ slide }: Props) => {
        ...
        <>
            ...
            <View style={ stylesInstructions.missionDescriptionWrapper }>
                ...
                <View style={ stylesInstructions.missionDescription }>
                    <View style={ stylesInstructions.missionPointsWrapper }>
                        ...
                        <Text style={ stylesInstructions.missionPoints }>
                            Ingresa a
                            <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> Reserva de cubículos </Text>
                        </Text>
                    </View>
                    <View style={ stylesInstructions.missionPointsWrapper }>
                        ...
                        <Text style={ stylesInstructions.missionPoints }>
                            Entérate de los
                            <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> requisitos y lo que debes tener en cuenta </Text>
                ...
                <Text style={ stylesInstructions.missionRemember }>
                    ¡Aprovecha los espacios que UPC te ofrece para motivarte en seguir aprendiendo y desarrollando tu potencial!
                </Text>
            </View>
            <TouchableOpacity
                activeOpacity={ 1 }
                ...
                onPress={ () => {
                    Linking.openURL('https://biblioteca.upc.edu.pe/portal/reservacubiculos')
                    setPrimaryButton(true)
                }}
            >
                <Text style={ stylesInstructions.buttonCodeText }>Ir a Reserva de cubículos</Text>
            </TouchableOpacity>
