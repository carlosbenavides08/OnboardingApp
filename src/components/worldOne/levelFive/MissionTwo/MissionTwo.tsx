...
export const MissionTwoLevelFive = ({ setQualify, setShowQuestion }: Props) => {
    ...
    const [alternatives, setAlternatives] = useState<ICheckboxButton[]>([
        {
            id: '0',
            text: 'Se pueden reservar cubículos hasta por 3 horas diarias 🗓️',
        ...
        {
            id: '1',
            text: 'El número de integrantes por grupo es de mínimo 2 y un máximo de acuerdo al aforo del espacio 👥',
            textStyle: [styles.textStyle, { textDecorationLine: 'none', fontFamily: 'WhitneyHTF-Medium', fontSize: 14 }],
            style: [styles.verticalStyle, { backgroundColor: 'white', padding: 8, marginRight: 15, borderRadius: 8 }],
            iconStyle: _iconStyle(),
            iconImageStyle: styles.iconImageStyle,
        ...
        {
            id: '2',
            text: 'La reserva expira automáticamente pasado los 15 min. de la hora de inicio ⏱️',
            textStyle: [styles.textStyle, { textDecorationLine: 'none', fontFamily: 'WhitneyHTF-Medium', fontSize: 14 }],
            style: [styles.verticalStyle, { backgroundColor: 'white', padding: 8, marginRight: 15, borderRadius: 8 }],
            iconStyle: _iconStyle(),
            iconImageStyle: styles.iconImageStyle,
    ...
    return (
        <>
            <Text style={ stylesMissionOne.question }>
                ¿Cuál de las afirmaciones sobre la reserva de cubículos es FALSA?
            </Text>
