...
export const InstructionsLevel5Mission4 = ({ slide }: Props) => {
                ...
                <View style={ stylesInstructions.missionDescription }>
                    <View style={ stylesInstructions.missionPointsWrapper }>
                        ...
                        <Text style={ stylesInstructions.missionPoints }>
                            Ingresa a
                            <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> Reserva de espacios deportivos </Text>
                        </Text>
                    </View>
                    <View style={ stylesInstructions.missionPointsWrapper }>
                        ...
                        <Text style={ stylesInstructions.missionPoints }>
                            Entérate de cómo
                            <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> realizar una reserva y hacer uso </Text>
                            de estos espacios
                        </Text>
                    </View>
                    <View style={ stylesInstructions.missionPointsWrapper }>
                        ...
                        <Text style={ stylesInstructions.missionPoints }>
                            Finalmente, responde una pregunta al
                            <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> completar la misión</Text>
                        </Text>
                    </View>
                </View>
                <Text style={ stylesInstructions.missionRemember }>
                    Recuerda que en UPC promovemos el deporte como parte de la formación y estilo de vida de nuestros estudiantes, por eso ¡te invitamos a ejercitarte!
                </Text>
            </View>
            <TouchableOpacity
                activeOpacity={ 1 }
                ...
                onPress={ () => {
                    Linking.openURL('https://www.upc.edu.pe/servicios/vida-universitaria/espacios-deportivos/reserva-de-espacios-deportivos/')
                    setPrimaryButton(true)
                }}
            >
                <Text style={ stylesInstructions.buttonCodeText }>Ir a Reserva de espacios deportivos</Text>
            </TouchableOpacity>
