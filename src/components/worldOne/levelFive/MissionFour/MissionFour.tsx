...
export const MissionFourLevelFive = ({ setQualify, setShowQuestion }: Props) => {
    ...
    const [alternatives, setAlternatives] = useState<ICheckboxButton[]>([
        {
            id: '0',
            text: 'Las reservas de espacios deportivos no se pueden cancelar 🚫',
        ...
        {
            id: '1',
            text: 'Para usar el gimnasio o la piscina tienes que firmar tú o tus padres (-18 años) una declaración de responsabilidad 📋',
            textStyle: [styles.textStyle, { textDecorationLine: 'none', fontFamily: 'WhitneyHTF-Medium', fontSize: 14 }],
            style: [styles.verticalStyle, { backgroundColor: 'white', padding: 8, marginRight: 15, borderRadius: 8 }],
            iconStyle: _iconStyle(),
            iconImageStyle: styles.iconImageStyle,
        ...
        {
            id: '2',
            text: 'Los espacios deportivos los pueden usar los alumnos y los colaboradores 🏐',
            textStyle: [styles.textStyle, { textDecorationLine: 'none', fontFamily: 'WhitneyHTF-Medium', fontSize: 14 }],
            style: [styles.verticalStyle, { backgroundColor: 'white', padding: 8, marginRight: 15, borderRadius: 8 }],
            iconStyle: _iconStyle(),
            iconImageStyle: styles.iconImageStyle,
    ...
    return (
        <>
            <Text style={ stylesMissionOne.question }>
                ¿Cuál de las afirmaciones sobre la reserva de espacios deportivos es FALSA?
            </Text>
