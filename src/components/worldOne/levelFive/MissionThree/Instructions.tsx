...
export const InstructionsLevel5Mission3 = ({ slide }: Props) => {
        ...
        <>
            ...
            <View style={ stylesInstructions.missionDescriptionWrapper }>
                ...
                <View style={ stylesInstructions.missionDescription }>
                    <View style={ stylesInstructions.missionPointsWrapper }>
                        ...
                        <Text style={ stylesInstructions.missionPoints }>
                            Ingresa a
                            <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> Reserva de computadoras </Text>
                        </Text>
                    </View>
                    <View style={ stylesInstructions.missionPointsWrapper }>
                ...
                <Text style={ stylesInstructions.missionRemember }>
                    ¡Utiliza los recursos que UPC te ofrece para seguir creciendo y desarrollando tus competencias!
                </Text>
            </View>
            <TouchableOpacity
                activeOpacity={ 1 }
                ...
                onPress={ () => {
                    Linking.openURL('https://biblioteca.upc.edu.pe/portal/reservacomputadora')
                    setPrimaryButton(true)
                }}
            >
                <Text style={ stylesInstructions.buttonCodeText }>Ir a Reserva de computadoras</Text>
            </TouchableOpacity>
