...
export const InstructionsLevel3Mission2 = ({ slide }: Props) => {
        ...
        <>
            ...
            <View style={ stylesInstructions.missionDescriptionWrapper }>
                ...
                <View style={ stylesInstructions.missionDescription }>
                    <View style={ stylesInstructions.missionPointsWrapper }>
                        ...
                        <Text style={ stylesInstructions.missionPoints }>
                            Revisa los
                            <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> eventos y actividades de la semana </Text>
                            de la agenda del Viernes Cultural
                        </Text>
                    </View>
                    <View style={ stylesInstructions.missionPointsWrapper }>
                        ...
                        <Text style={ stylesInstructions.missionPoints }>
                            Participa en el
                            <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> evento o actividad que más te interese </Text>
                    ...
                    <View style={ stylesInstructions.missionPointsWrapper }>
                        ...
                        <Text style={ stylesInstructions.missionPoints }>
                            Por último, sube una foto en un Viernes Cultural al
                ...
                <Text style={ stylesInstructions.missionRemember }>
                    Recuerda que
                    <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> todos los miércoles se comunica la Agenda del Viernes Cultural </Text>
                    de la semana. ¡No te pierdas de nada y revisa siempre todo lo que tenemos para ti!
                </Text>
            </View>
            <TouchableOpacity
                activeOpacity={ 1 }
