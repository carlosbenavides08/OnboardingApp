...
export const InstructionsLevel3Mission1 = ({ slide }: Props) => {
                ...
                <View style={ stylesInstructions.missionDescription }>
                    <View style={ stylesInstructions.missionPointsWrapper }>
                        ...
                        <Text style={ stylesInstructions.missionPoints }>
                            Ingresa a la
                            <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> Agenda del Viernes Cultural </Text>
                            y revisa nuestros eventos y actividades
                        </Text>
                    </View>
                    <View style={ stylesInstructions.missionPointsWrapper }>
                        <Text style={ stylesInstructions.missionPoints }>2.</Text>
                        <Text style={ stylesInstructions.missionPoints }>
                            Ingresa al instagram
                            <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> Vida Universitaria UPC </Text>
                            y descubre nuevas actividades
                        </Text>
                    </View>
                    <View style={ stylesInstructions.missionPointsWrapper }>
                        <Text style={ stylesInstructions.missionPoints }>3.</Text>
                        <Text style={ stylesInstructions.missionPoints }>
                            Sigue nuestra página de instagram y
                            <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> haz una captura de tu pantalla </Text>
                            cuando lo hagas
                        </Text>
                    </View>
                    <View style={ stylesInstructions.missionPointsWrapper }>
                        ...
                        <Text style={ stylesInstructions.missionPoints }>
                            Por último, sube esta captura al
                            <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> Ir a completar misión</Text>
                        </Text>
                    </View>
                </View>
                <Text style={ stylesInstructions.missionRemember }>¡No olvides compartir las actividades de tu interés con amigos y participar juntos en ellas!</Text>
            </View>
            <TouchableOpacity
                activeOpacity={ 1 }
                style={ stylesInstructions.buttonCode }
                onPress={ () => {
                    Linking.openURL('https://cerbero.upc.edu.pe/apps/gmailingpregrado/Mailing.aspx?idMailing=28112&idTele=23')
                    setPrimaryButton(true)
                }}
            >
                <Text style={ stylesInstructions.buttonCodeText }>Ver Agenda del Viernes Cultural</Text>
            </TouchableOpacity>
            <View style={ stylesInstructions.secondaryButtonContainer }>
                <TouchableOpacity
                    activeOpacity={ 1 }
                    onPress={ () => {
                        Linking.openURL('https://www.instagram.com/vidauniversitariaupc_oficial/')
                        setSecondaryButton(true)
                    }}
                >
                    <Text style={ stylesInstructions.secondaryButtonText }>Ir a instagram Vida Universitaria UPC</Text>
                </TouchableOpacity>
                <Image
