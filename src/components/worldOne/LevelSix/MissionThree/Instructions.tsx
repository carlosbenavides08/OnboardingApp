...
export const InstructionsLevel6Mission3 = ({ slide, setQualify }: Props) => {
                ...
                <View style={ stylesInstructions.missionDescription }>
                    <View style={ stylesInstructions.missionPointsWrapper }>
                        ...
                        <Text style={ stylesInstructions.missionPoints }>
                            Lee la
                            <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> información importante sobre la subsanación y recuperación </Text>
                            de evaluaciones
                        </Text>
                    </View>
                    <View style={ stylesInstructions.missionPointsWrapper }>
                        ...
                        <Text style={ stylesInstructions.missionPoints }>
                            Si tienes la necesidad de realizar uno de estos trámites puedes
                            <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> ver el tutorial de cómo realizarlo</Text>
                        </Text>
                    </View>
                    <View style={ stylesInstructions.missionPointsWrapper }>
                        <Text style={ stylesInstructions.missionPoints }>3.</Text>
                        <Text style={ stylesInstructions.missionPoints }>
                            Finalmente, ten en cuenta que solo puedes gestionar un trámite por curso
                        </Text>
                    </View>
                </View>
                <Text style={ stylesInstructions.missionRemember }>
                    Recuerda que la recuperación y subsanación es para evaluaciones no rendidas, no se realizan evaluaciones sustitutorias.
                </Text>
            </View>
            <TouchableOpacity
                activeOpacity={ 1 }
                ...
                onPress={ () => {
                    Linking.openURL('https://contactoweb.upc.edu.pe/recuperacion-de-evaluaciones/quiero-recuperar-una-practica-u-examen-parcial-que-no-rendi-que-debo-hacer')
                    setPrimaryButton(true)
                }}
            >
                <Text style={ stylesInstructions.buttonCodeText }>Ir a información importante</Text>
            </TouchableOpacity>
            <View style={ stylesInstructions.viewRulesContainer }>
                <TouchableOpacity
                    activeOpacity={ 1 }
                    onPress={ () => {
                        Linking.openURL('https://www.upc.edu.pe/servicios/tutoriales-de-tramites/documentos/recuperacion-de-evaluacion-no-rendida-22.10.pdf')
                        setSecondaryButton(true)
                    }}
                >
                    <Text style={ stylesInstructions.viewRulesText }>Ir a tutorial para realizar trámite</Text>
                </TouchableOpacity>
                <Image
