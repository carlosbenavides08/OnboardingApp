...
export const InstructionsLevel10Mission3 = ({ slide }: Props) => {
    ...
    return (
        <>
            ...
            <View style={ stylesInstructions.missionDescriptionWrapper }>
                ...
                <View style={ stylesInstructions.missionPointsWrapper }>
                        ...
                        <Text style={ stylesInstructions.missionPoints }>
                            Ingresa a
                            <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> Intranet (Sócrates)</Text>
                        </Text>
                    </View>
                    <View style={ stylesInstructions.missionPointsWrapper }>
                        <Text style={ stylesInstructions.missionPoints }>2.</Text>
                        <Text style={ stylesInstructions.missionPoints }>
                            Conoce el horario y el aula de cada evaluación final en
                            <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> Consulta de Horarios</Text>
                        </Text>
                    </View>
                    <View style={ stylesInstructions.missionPointsWrapper }>
                        ...
                        <Text style={ stylesInstructions.missionPoints }>
                            En caso sea
                            <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> presencial</Text>
                            , dirígete al campus con anticipación para que ubiques el aula
                        </Text>
                    </View>
                    <View style={ stylesInstructions.missionPointsWrapper }>
                    ...
                    <View style={ stylesInstructions.missionPointsWrapper }>
                        ...
                        <Text style={ stylesInstructions.missionPoints }>
                            Finalmente, tómate una foto cuando hayas finalizado tu último final y súbela al
                            <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> Ir a completar misión</Text>
                        </Text>
                    </View>
                </View>
                <Text style={ stylesInstructions.missionRemember }>
                    Recuerda que en caso no hayas rendido una evaluación, puedes realizar aún el trámite de
                    <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> recuperación/subsanación de evaluación</Text>
            ...
            <TouchableOpacity
                ...
                onPress={ () => {
                    Linking.openURL('http://matricula.upc.edu.pe/')
                    setPrimaryButton(true)
                }}
            >
                <Text style={ stylesInstructions.buttonCodeText }>Ir a Intranet (Sócrates)</Text>
            </TouchableOpacity>
            <View style={ stylesInstructions.viewRulesContainer }>
                ...
                >
                    <Text style={ stylesInstructions.viewRulesText }>Ir a Tutorial de recuperación de evaluación</Text>
                </TouchableOpacity>
                <Image
