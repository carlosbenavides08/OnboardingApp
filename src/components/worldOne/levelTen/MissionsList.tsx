...
export const MissionsListLevel10 = ({ navigation }: Props) => {
    ...
    useEffect(() => {
        saveMissions([
            {
                title: 'PLANIFICA TUS ÚLTIMAS SEMANAS DEL CICLO',
                description: 'Organízate para finalizar el ciclo con éxito y sin ningún inconveniente.'
            },
            {
                title: 'ASISTE A TU ÚLTIMA SEMANA DE CLASES',
                description: 'Prepárate para finalizar las clases de tu 1° ciclo universitario.'
            },
            {
                title: 'ASISTE A TUS EVALUACIONES FINALES',
                description: 'Realiza tus Evaluaciones Finales y cierra con éxito tu 1° ciclo universitario.'
            }
        ])
    }, [])
        ...
        <>
            ...
            >
                ...
                <View>
                    ...
                    <Text style={ stylesMissionsList.missionTitle }>PLANIFICA TUS ÚLTIMAS SEMANAS DEL CICLO</Text>
            ...
            <TouchableOpacity
                ...
                style={[
                    ...
                    authentication.levels.find(level => level.numberLevel! === 10)?.completedMissions! < 1 ? stylesMissionsList.missionCardLocked : null
                ]}
                disabled={ authentication.levels.find(level => level.numberLevel! === 10)?.completedMissions! < 1 }
            ...
            >
                {
                    ...
                    : authentication.levels.find(level => level.numberLevel! === 10)?.completedMissions! < 1
                    ? (
                        <Image
                ...
                <View>
                    ...
                    <Text style={ stylesMissionsList.missionTitle }>ASISTE A TU ÚLTIMA SEMANA DE CLASES</Text>
            ...
            <TouchableOpacity
                ...
                style={[
                    stylesMissionsList.missionCard,
                    authentication.levels.find(level => level.numberLevel! === 10)?.completedMissions! < 2 ? stylesMissionsList.missionCardLocked : null
                ]}
                disabled={ authentication.levels.find(level => level.numberLevel! === 10)?.completedMissions! < 2 }
            ...
            >
                {
                    ...
                    : authentication.levels.find(level => level.numberLevel! === 10)?.completedMissions! < 2
                    ? (
                        <Image
                            source={ require('../../../assets/mission-locked.png') }
                            style={{ width: 24, height: 24 }}
                ...
                <View>
                    ...
                    <Text style={ stylesMissionsList.missionTitle }>ASISTE A TUS EVALUACIONES FINALES</Text>
