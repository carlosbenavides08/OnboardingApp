...
export const InstructionsLevel10Mission2 = ({ slide }: Props) => {
                ...
                <View style={ stylesInstructions.missionDescription }>
                    <View style={ stylesInstructions.missionPointsWrapper }>
                        ...
                        <Text style={ stylesInstructions.missionPoints }>
                            Asiste a las clases de tu
                            <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> última semana</Text>
                        </Text>
                    </View>
                    <View style={ stylesInstructions.missionPointsWrapper }>
                        <Text style={ stylesInstructions.missionPoints }>2.</Text>
                        <Text style={ stylesInstructions.missionPoints }>
                            Una vez que termines tu última clase del ciclo, tómate una foto
                            <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> celebrando el logro</Text>
                        </Text>
                    </View>
                    <View style={ stylesInstructions.missionPointsWrapper }>
                        <Text style={ stylesInstructions.missionPoints }>3.</Text>
                        <Text style={ stylesInstructions.missionPoints }>
                            Finalmente, sube la foto al
