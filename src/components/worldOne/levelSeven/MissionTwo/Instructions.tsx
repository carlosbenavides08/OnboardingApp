...
export const InstructionsLevel7Mission2 = ({ slide, setQualify }: Props) => {
                ...
                <View style={ stylesInstructions.missionDescription }>
                    <View style={ stylesInstructions.missionPointsWrapper }>
                        ...
                        <Text style={ stylesInstructions.missionPoints }>
                            ...
                            <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> Pasaporte de Actividades Culturales </Text>
                            de evaluaciones
                        </Text>
                    </View>
                    <View style={ stylesInstructions.missionPointsWrapper }>
                        ...
                        <Text style={ stylesInstructions.missionPoints }>
                            Revisa la
                            <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> infografía y video de cómo funciona </Text>
                            el pasaporte
                        </Text>
                    </View>
                    <View style={ stylesInstructions.missionPointsWrapper }>
                        ...
                        <Text style={ stylesInstructions.missionPoints }>
                            Finalmente, conoce y haz click en las
                            <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> entidades culturales </Text>
                            con quien tenemos alianza, y descubre las actividades que tienen
                        </Text>
                    </View>
                </View>
                <Text style={ stylesInstructions.missionRemember }>
                    Te recordamos que al completar el Pasaporte de Actividades Culturales puedes
                    <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> obtener 1 crédito extraacadémico</Text>.
                    Te recomendamos que lo tengas presente durante tu vida universitaria.
                </Text>
            </View>
            <TouchableOpacity
                activeOpacity={ 1 }
                ...
                onPress={ () => {
                    Linking.openURL('https://www.upc.edu.pe/servicios/vida-universitaria/pasaporte-de-actividades-culturales-modalidad-semipresencial/')
                    setPrimaryButton(true)
                }}
            >
                <Text style={ stylesInstructions.buttonCodeText }>Ir a Pasaporte de Actividades Culturales</Text>
            </TouchableOpacity>
