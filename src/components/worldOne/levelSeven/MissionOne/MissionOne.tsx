...
export const MissionOneLevelSeven = ({ setQualify, setShowQuestion }: Props) => {
    ...
    return (
        <>
            <Text style={ stylesMissionTwo.question }>
                Completa esta misión subiendo una captura de pantalla de la exhibición o programa que más te gustó.
            </Text>
