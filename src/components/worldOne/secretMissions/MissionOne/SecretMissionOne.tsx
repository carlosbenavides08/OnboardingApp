...
export const SecretMissionOne = ({ setQualify, setShowQuestion }: Props) => {
    ...
    const [alternatives, setAlternatives] = useState<ICheckboxButton[]>([
        {
            id: '0',
            text: 'Antes de aprobar 110 créditos académicos (Nivel básico 🔤)',
        ...
        {
            id: '1',
            text: 'A partir de los 110 créditos cumplidos y antes de egresar (Nivel intermedio 🌟)',
            textStyle: [styles.textStyle, { textDecorationLine: 'none', fontFamily: 'WhitneyHTF-Medium', fontSize: 14 }],
            style: [styles.verticalStyle, { backgroundColor: 'white', padding: 8, borderRadius: 8 }],
            iconStyle: _iconStyle(),
            iconImageStyle: styles.iconImageStyle,
        ...
        {
            id: '2',
            text: 'Ambos momentos son obligatorios ✔️✔️',
            textStyle: [styles.textStyle, { textDecorationLine: 'none', fontFamily: 'WhitneyHTF-Medium', fontSize: 14 }],
            style: [styles.verticalStyle, { backgroundColor: 'white', padding: 8, borderRadius: 8 }],
            iconStyle: _iconStyle(),
            iconImageStyle: styles.iconImageStyle,
    ...
    return (
        <>
            <Text style={ stylesMissionThree.question }>
                ¿En qué momento debo certificar el inglés de manera obligatoria?
            </Text>
