...
export const InstructionsLevel4Mission2 = ({ slide }: Props) => {
            ...
            <View style={ stylesInstructions.missionDescriptionWrapper }>
                ...
                <View style={ stylesInstructions.missionDescription }>
                    ...
                    <View style={ stylesInstructions.missionPointsWrapper }>
                        ...
                        <Text style={ stylesInstructions.missionPoints }>
                            Conoce cómo acceder a estos beneficios en
                            <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> Atención de servicios </Text>
                        </Text>
                    </View>
                    <View style={ stylesInstructions.missionPointsWrapper }>
                ...
                <Text style={ stylesInstructions.missionRemember }>
                    Recuerda que todas nuestras asesorías psicopedagógicas son gratuitas. Accede a ellas y cuida de tu bienestar emocional.
                </Text>
            </View>
            <TouchableOpacity
                activeOpacity={ 1 }
                ...
                onPress={ () => {
                    Linking.openURL('https://www.upc.edu.pe/servicios/orientacion-psicopedagogica/')
                    setPrimaryButton(true)
                }}
            >
                <Text style={ stylesInstructions.buttonCodeText }>Ir a Orientación psicopedagógica</Text>
            </TouchableOpacity>
