...
export const MissionOneLevelFour = ({ setQualify, setShowQuestion }: Props) => {
    ...
    const [alternatives, setAlternatives] = useState<ICheckboxButton[]>([
        {
            id: '0',
            text: 'Puedes ser delegado solo de un curso por cada ciclo 📚',
        ...
        {
            id: '1',
            text: 'Para obtener el crédito extraacadémico es necesario asistir a reuniones en las que son convocados 🧑‍💻',
            textStyle: [styles.textStyle, { textDecorationLine: 'none', fontFamily: 'WhitneyHTF-Medium', fontSize: 14 }],
            style: [styles.verticalStyle, { backgroundColor: 'white', padding: 8, borderRadius: 8 }],
            iconStyle: _iconStyle(),
            iconImageStyle: styles.iconImageStyle,
        ...
        {
            id: '2',
            text: 'Ser delegado permite desarrollar la capacidad de liderazgo del estudiante ⚡',
            textStyle: [styles.textStyle, { textDecorationLine: 'none', fontFamily: 'WhitneyHTF-Medium', fontSize: 14 }],
            style: [styles.verticalStyle, { backgroundColor: 'white', padding: 8, borderRadius: 8 }],
            iconStyle: _iconStyle(),
            iconImageStyle: styles.iconImageStyle,
    ...
    return (
        <>
            <Text style={ stylesMissionOne.question }>
                ¿Cuál de las afirmaciones sobre la función del delegado es FALSA?
            </Text>
