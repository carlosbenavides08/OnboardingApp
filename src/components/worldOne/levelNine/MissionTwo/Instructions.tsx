...
export const InstructionsLevel9Mission2 = ({ slide }: Props) => {
                ...
                <View style={ stylesInstructions.missionDescription }>
                    <View style={ stylesInstructions.missionPointsWrapper }>
                        ...
                        <Text style={ stylesInstructions.missionPoints }>
                            Revisa el artículo
                            <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> ¿Dónde ubico la Oficina Internacional? </Text>
                            en Contacto Web UPC
                        </Text>
                    </View>
                    <View style={ stylesInstructions.missionPointsWrapper }>
                        ...
                        <Text style={ stylesInstructions.missionPoints }>
                            Conoce en qué pabellón se encuentra la oficina y el horario de atención según tu campus
                        </Text>
                    </View>
                    <View style={ stylesInstructions.missionPointsWrapper }>
                        <Text style={ stylesInstructions.missionPoints }>3.</Text>
                        <Text style={ stylesInstructions.missionPoints }>
                            Dirígete a la Oficina Internacional de tu campus y tómate una foto con el representante de la oficina
                        </Text>
                    </View>
                    <View style={ stylesInstructions.missionPointsWrapper }>
                        <Text style={ stylesInstructions.missionPoints }>2.</Text>
                        <Text style={ stylesInstructions.missionPoints }>
                            Finalmente, sube la foto con el representante al
                            <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> Ir a completar misión</Text>
                        </Text>
                    </View>
                </View>
                <Text style={ stylesInstructions.missionRemember }>
                    También puedes resolver dudas a través de nuestros
                    <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> canales de contacto </Text>
                    , los cuales podrás encontrar en la web
                    <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> UPC Internacional </Text>
                    al hacer clic en
                    <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> “Información”</Text>.
                </Text>
            </View>
            <TouchableOpacity
                activeOpacity={ 1 }
                ...
                onPress={ () => {
                    Linking.openURL('https://contactoweb.upc.edu.pe/77755-convenios-internacionales/donde-ubico-la-oficina-internacional-de-mi-campus')
                    setPrimaryButton(true)
                }}
            >
                <Text style={ stylesInstructions.buttonCodeText }>Ir a ¿Dónde ubico la Oficina Internacional?</Text>
            </TouchableOpacity>
            <View style={ stylesInstructions.viewRulesContainer }>
                <TouchableOpacity
                    activeOpacity={ 1 }
                    onPress={ () => {
                        Linking.openURL('https://internacional.upc.edu.pe/')
