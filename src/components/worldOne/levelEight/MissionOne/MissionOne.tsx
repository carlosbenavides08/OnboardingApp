...
export const MissionOneLevelEight = ({ setQualify, setShowQuestion }: Props) => {
    ...
    return (
        <>
            <Text style={ stylesMissionOne.question }>
                ¿Qué causa de procrastinación te ha sucedido y qué estrategia utilizarías para enfrentarla?
            </Text>
