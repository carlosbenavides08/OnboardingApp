...
export const InstructionsLevel8Mission1 = ({ slide }: Props) => {
                ...
                <View style={ stylesInstructions.missionDescription }>
                    <View style={ stylesInstructions.missionPointsWrapper }>
                        ...
                        <Text style={ stylesInstructions.missionPoints }>
                            Revisar la guía informativa
                            <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> Desafiando mi postergación, </Text>
                            y aprende sobre la procrastinación y cómo enfrentarla
                        </Text>
                    </View>
                    <View style={ stylesInstructions.missionPointsWrapper }>
                        <Text style={ stylesInstructions.missionPoints }>2.</Text>
                        <Text style={ stylesInstructions.missionPoints }>
                            Finalmente, identifica una causa de procrastinación que te haya sucedido y responde la pregunta al
                            <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> Ir a completar misión </Text>
                        </Text>
                    </View>
                </View>
                <Text style={ stylesInstructions.missionRemember }>
                    Si consideras que sueles postergas tus tareas, te recomendamos que te contactes con
                    <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> Orientación Psicopedagógica </Text>
                    y participes de los
                    <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> talleres </Text>
                    sobre cómo manejar la postergación.
                </Text>
            </View>
            <TouchableOpacity
                activeOpacity={ 1 }
                ...
                onPress={ () => {
                    Linking.openURL('https://res.cloudinary.com/upcbinary/image/upload/v1638402381/institucional/servicios/orientacion-psicopedagogica/guia-desafiando-mi-postergacion_rl4pud.pdf')
                    setPrimaryButton(true)
                }}
            >
                <Text style={ stylesInstructions.buttonCodeText }>Ir a Desafiando mi postergación</Text>
            </TouchableOpacity>
            <View style={ stylesInstructions.viewRulesContainer }>
                <TouchableOpacity
                    activeOpacity={ 1 }
                    onPress={ () => {
                        Linking.openURL('https://www.upc.edu.pe/servicios/orientacion-psicopedagogica/atencion-de-servicios/')
                        setSecondaryButton(true)
                    }}
                >
                    <Text style={ stylesInstructions.viewRulesText }>Ir a Contacto Orientación Psicopedagógica</Text>
                </TouchableOpacity>
                <Image
