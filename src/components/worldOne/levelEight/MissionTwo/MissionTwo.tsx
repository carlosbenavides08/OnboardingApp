...
export const MissionTwoLevelEight = ({ setQualify, setShowQuestion }: Props) => {
    ...
    return (
        <>
            <Text style={ stylesMissionOne.question }>
                ¿Qué conductas realizas que no contribuyen a una vida saludable y qué acciones harías para evitarlas?
            </Text>
