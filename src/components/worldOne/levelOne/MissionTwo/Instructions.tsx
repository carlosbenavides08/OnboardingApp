...
export const InstructionsLevel1Mission2 = ({ slide }: Props) => {
        ...
        <>
                ...
                <View style={ stylesInstructions.missionDescription }>
                    ...
                    <View style={ stylesInstructions.missionPointsWrapper }>
                        ...
                        <Text style={ stylesInstructions.missionPoints }>
                            ...
                            , ingresa al
                            <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> Aula Virtual (Blackboard) </Text>
                            y conéctate a la video conferencia
                        </Text>
                    </View>
                    <View style={ stylesInstructions.missionPointsWrapper }>
                        ...
                        <Text style={ stylesInstructions.missionPoints }>
                            ...
                            , dirígete al
                            <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> campus </Text>
                            con anticipación y ubica tu salón
                        </Text>
                    </View>
                    <View style={ stylesInstructions.missionPointsWrapper }>
                        <Text style={ stylesInstructions.missionPoints }>4.</Text>
                        <Text style={ stylesInstructions.missionPoints }>
                            Por último, tómate una foto en clase y súbela al
                            <Text style={{ fontFamily: 'WhitneyHTF-Bold' }}> Ir a completar misión</Text>
                        </Text>
                    </View>
                </View>
                <Text style={ stylesInstructions.missionRemember }>¡No te pierdas de ninguna clase! Recuerda agregar un recordatorio para asistir a tus clases sin inconveniente.</Text>
            </View>
            <TouchableOpacity
                activeOpacity={ 1 }
            ...
            <TouchableOpacity
                ...
                style={[
                    ...
                    !completeMission ? stylesInstructions.buttonCompleteMissionDisabled : null
                ]}
                onPress={ slide }
                disabled={ !completeMission }
            >
                <Text style={[
                    stylesInstructions.buttonCompleteText,
                    !completeMission ? stylesInstructions.buttonTextDisabled : null
